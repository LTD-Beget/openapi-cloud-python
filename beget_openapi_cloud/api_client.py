...
from beget_openapi_cloud import rest
from beget_openapi_cloud.configuration import Configuration
from beget_openapi_cloud.exceptions import ApiTypeError, ApiValueError
from beget_openapi_cloud.schemas import (
    NoneClass,
    BoolClass,
    Schema,
    FileIO,
...
class ApiClient:
    ...
    def __init__(
        ...
        self.user_agent = 'OpenAPI-Generator/v1.6.4/python'
