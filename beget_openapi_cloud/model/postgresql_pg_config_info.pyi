...
class PostgresqlPgConfigInfo(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class param_config(
                ...
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['StructuresParamConfig'], typing.List['StructuresParamConfig']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'param_config':
                    return super().__new__(
                        cls,
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["param_default", "param_config", "param", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["param_default", "param_config", "param", ], str]):
        return super().get_item_oapg(name)
