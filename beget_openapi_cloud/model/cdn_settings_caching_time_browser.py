...
class CdnSettingsCachingTimeBrowser(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["enable", "time", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["enable", "time", ], str]):
