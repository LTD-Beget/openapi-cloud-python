...
class S3S3(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class cors(
                ...
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['S3Cors'], typing.List['S3Cors']],
            ...
            @staticmethod
            def attached_cdn() -> typing.Type['S3S3Cdn']:
                return S3S3Cdn
            __annotations__ = {
                "public": public,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["attached_cdn"]) -> 'S3S3Cdn': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["public", "access_key", "secret_key", "fqdn", "cors", "quota_used_size", "ftp", "sftp", "attached_cdn", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["attached_cdn"]) -> typing.Union['S3S3Cdn', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["public", "access_key", "secret_key", "fqdn", "cors", "quota_used_size", "ftp", "sftp", "attached_cdn", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        attached_cdn: typing.Union['S3S3Cdn', schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
