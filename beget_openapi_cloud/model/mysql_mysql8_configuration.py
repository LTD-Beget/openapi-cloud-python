...
class MysqlMysql8Configuration(
    schemas.DictSchema
):
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["cpu_count", "disk_size", "memory", "version", "display_version", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["cpu_count", "disk_size", "memory", "version", "display_version", ], str]):
