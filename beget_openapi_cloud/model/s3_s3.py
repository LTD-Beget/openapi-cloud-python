...
class S3S3(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["public", "access_key", "secret_key", "fqdn", "cors", "quota_used_size", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["public", "access_key", "secret_key", "fqdn", "cors", "quota_used_size", ], str]):
