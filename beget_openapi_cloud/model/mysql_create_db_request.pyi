...
class MysqlCreateDbRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["service_id", "db_name", "password", "save_pma_password", "description", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["service_id", "db_name", "password", "save_pma_password", "description", ], str]):
