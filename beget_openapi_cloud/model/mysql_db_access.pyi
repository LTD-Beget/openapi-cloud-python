...
class MysqlDbAccess(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["host", "password", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["host", "password", ], str]):
