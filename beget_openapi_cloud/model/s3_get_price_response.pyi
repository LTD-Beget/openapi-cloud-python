...
class S3GetPriceResponse(
        ...
        class properties:
            ...
            class bucket(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['S3GetPriceResponseBucket']:
                        return S3GetPriceResponseBucket
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['S3GetPriceResponseBucket'], typing.List['S3GetPriceResponseBucket']],
                ...
                def __getitem__(self, i: int) -> 'S3GetPriceResponseBucket':
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        bucket: typing.Union[MetaOapg.properties.bucket, list, tuple, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
