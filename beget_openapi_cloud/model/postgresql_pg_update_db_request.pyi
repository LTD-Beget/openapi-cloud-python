...
class PostgresqlPgUpdateDbRequest(
    schemas.DictSchema
):
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["service_id", "db_name", "description", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["service_id", "db_name", "description", ], str]):
