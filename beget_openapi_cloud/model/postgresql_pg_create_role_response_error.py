...
class PostgresqlPgCreateRoleResponseError(
    schemas.DictSchema
):
            ...
            class code(
                ...
                class MetaOapg:
                    ...
                    enum_value_to_name = {
                        ...
                        "INVALID_PARENT_ROLE_LIST": "INVALID_PARENT_ROLE_LIST",
                ...
                @schemas.classproperty
                def ROLE_ALREADY_EXISTS(cls):
                    return cls("ROLE_ALREADY_EXISTS")
                ...
                @schemas.classproperty
                def INVALID_PARENT_ROLE_LIST(cls):
                    return cls("INVALID_PARENT_ROLE_LIST")
