...
class ProjectGetProjectListResponseProjectPage(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class projects(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['ProjectProject']:
                        return ProjectProject
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['ProjectProject'], typing.List['ProjectProject']],
                ...
                def __getitem__(self, i: int) -> 'ProjectProject':
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["projects", "total_count", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["projects", "total_count", ], str]):
