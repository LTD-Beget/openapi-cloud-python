...
class CdnSettingsIpAddressAcl(
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["excepted_ip"]) -> MetaOapg.properties.excepted_ip: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["enable", "policy_type", "excepted_ip", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["excepted_ip"]) -> typing.Union[MetaOapg.properties.excepted_ip, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["enable", "policy_type", "excepted_ip", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        excepted_ip: typing.Union[MetaOapg.properties.excepted_ip, list, tuple, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
