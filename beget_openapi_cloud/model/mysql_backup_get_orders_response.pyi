...
class MysqlBackupGetOrdersResponse(
    schemas.DictSchema
):
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class order(
                ...
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['StructuresMysqlRestoreOrder'], typing.List['StructuresMysqlRestoreOrder']],
                ...
                def __getitem__(self, i: int) -> 'StructuresMysqlRestoreOrder':
