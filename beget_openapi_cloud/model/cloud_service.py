...
class CloudService(
            ...
            class status_details(
                ...
                class MetaOapg:
                    ...
                    enum_value_to_name = {
                        ...
                        "SUSPENDED_SERVICE_MAINTENANCE": "SUSPENDED_SERVICE_MAINTENANCE",
                    }
                ...
                @schemas.classproperty
                def SUSPENDED_INSUFFICIENT_FUNDS(cls):
                    return cls("SUSPENDED_INSUFFICIENT_FUNDS")
                
                @schemas.classproperty
                def SUSPENDED_SERVICE_MAINTENANCE(cls):
                    return cls("SUSPENDED_SERVICE_MAINTENANCE")
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "configuration_id", "display_name", "description", "project_id", "ui_pinned", "ui_pin_changed_at", "status", "status_details", "created_at", "price_day", "price_month", "mysql5", "mysql8", "mysql84", "postgresql15", "postgresql14", "postgresql164", "s3", "cdn", "manage_enabled", "slug", "monitorable_resources", "unblocking", "migrating", "region", "type", "restoring", "display_rank", ], str]):
