...
class S3GetPrefixResponse(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["prefix", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["prefix", ], str]):
