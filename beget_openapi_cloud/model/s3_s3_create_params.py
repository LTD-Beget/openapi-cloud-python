...
class S3S3CreateParams(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["public", "bucket_name", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["public", "bucket_name", ], str]):
