...
class MysqlSetConfigRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["service_id", "param", "preset_name", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["service_id", "param", "preset_name", ], str]):
        return super().get_item_oapg(name)
