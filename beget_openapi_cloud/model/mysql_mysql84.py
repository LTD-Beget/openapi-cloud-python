...
class MysqlMysql84(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def configuration() -> typing.Type['MysqlMysql84Configuration']:
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["configuration"]) -> 'MysqlMysql84Configuration': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["configuration"]) -> typing.Union['MysqlMysql84Configuration', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        configuration: typing.Union['MysqlMysql84Configuration', schemas.Unset] = schemas.unset,
