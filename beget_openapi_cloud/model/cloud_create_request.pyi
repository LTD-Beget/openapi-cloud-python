...
class CloudCreateRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["configuration_id", "display_name", "description", "mysql_params", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["configuration_id", "display_name", "description", "mysql_params", ], str]):
