...
class CloudCreateRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["configuration_id", "display_name", "description", "mysql_params", "postgresql_params", "s3_params", "cdn_params", "extra", "region", "project_id", "ui_pinned", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["configuration_id", "display_name", "description", "mysql_params", "postgresql_params", "s3_params", "cdn_params", "extra", "region", "project_id", "ui_pinned", ], str]):
