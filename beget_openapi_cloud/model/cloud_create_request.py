...
class CloudCreateRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["configuration_id", "display_name", "description", "mysql_params", "postgresql_params", "s3_params", "cdn_params", "extra", "region", "project_id", "ui_pinned", "ui_pinned_after_rank", "ui_pinned_before_rank", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["configuration_id", "display_name", "description", "mysql_params", "postgresql_params", "s3_params", "cdn_params", "extra", "region", "project_id", "ui_pinned", "ui_pinned_after_rank", "ui_pinned_before_rank", ], str]):
