...
class CdnSettingsAllowedHttpMethods(
    schemas.DictSchema
):
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["enable", "http_method", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["enable", "http_method", ], str]):
