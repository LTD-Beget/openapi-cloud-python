            ...
            class code(
                ...
                class MetaOapg:
                    ...
                    enum_value_to_name = {
                        ...
                        "DB_NAME_IS_RESERVED": "DB_NAME_IS_RESERVED",
                        "ROLE_NAME_IS_RESERVED": "ROLE_NAME_IS_RESERVED",
                ...
                @schemas.classproperty
                def INVALID_DB_NAME(cls):
                    return cls("INVALID_DB_NAME")
                
                @schemas.classproperty
                def INVALID_ROLE_NAME(cls):
                    return cls("INVALID_ROLE_NAME")
                ...
                @schemas.classproperty
                def INVALID_CONFIG_PARAMS(cls):
                    return cls("INVALID_CONFIG_PARAMS")
                
                @schemas.classproperty
                def DB_NAME_IS_RESERVED(cls):
                    return cls("DB_NAME_IS_RESERVED")
                
                @schemas.classproperty
                def ROLE_NAME_IS_RESERVED(cls):
                    return cls("ROLE_NAME_IS_RESERVED")
