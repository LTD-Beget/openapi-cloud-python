...
class StructuresMysqlCopy(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "service_uuid", "service_name", "version", "date", "size", "region", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "service_uuid", "service_name", "version", "date", "size", "region", ], str]):
