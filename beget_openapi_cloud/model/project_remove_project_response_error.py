...
class ProjectRemoveProjectResponseError(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class code(
                ...
                class MetaOapg:
                    ...
                    enum_value_to_name = {
                        "_": "_",
                        "CANNOT_DELETE_DEFAULT_PROJECT": "CANNOT_DELETE_DEFAULT_PROJECT",
                    }
                ...
                @schemas.classproperty
                def CANNOT_DELETE_DEFAULT_PROJECT(cls):
                    return cls("CANNOT_DELETE_DEFAULT_PROJECT")
            __annotations__ = {
                "message": message,
                "code": code,
            }
