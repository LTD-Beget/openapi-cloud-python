...
class CdnSettingsGzipCompression(
    schemas.DictSchema
):
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["enable", "content_type", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["enable", "content_type", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        content_type: typing.Union[MetaOapg.properties.content_type, list, tuple, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
