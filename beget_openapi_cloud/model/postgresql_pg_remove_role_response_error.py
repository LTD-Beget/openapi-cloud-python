...
class PostgresqlPgRemoveRoleResponseError(
    schemas.DictSchema
):
            ...
            class code(
                ...
                class MetaOapg:
                    ...
                    enum_value_to_name = {
                        ...
                        "ROLE_IS_DB_OWNER": "ROLE_IS_DB_OWNER",
                        "ROLE_IS_PREDEFINED": "ROLE_IS_PREDEFINED",
                    }
                ...
                @schemas.classproperty
                def ROLE_IS_DB_OWNER(cls):
                    return cls("ROLE_IS_DB_OWNER")
                
                @schemas.classproperty
                def ROLE_IS_PREDEFINED(cls):
                    return cls("ROLE_IS_PREDEFINED")
            __annotations__ = {
                "message": message,
                "code": code,
            }
