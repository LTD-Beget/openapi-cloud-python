...
class ProjectUpdateProjectResponseError(
    schemas.DictSchema
):
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class code(
                ...
                @schemas.classproperty
                def INVALID_PROJECT_NAME(cls):
                    return cls("INVALID_PROJECT_NAME")
                
                @schemas.classproperty
                def INVALID_PROJECT_DESCRIPTION(cls):
                    return cls("INVALID_PROJECT_DESCRIPTION")
            __annotations__ = {
                "message": message,
                "code": code,
            }
