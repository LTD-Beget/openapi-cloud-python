...
class CloudServiceConfiguration(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "price_day", "price_month", "region", "mysql5", "mysql8", "postgresql15", "postgresql14", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "price_day", "price_month", "region", "mysql5", "mysql8", "postgresql15", "postgresql14", ], str]):
