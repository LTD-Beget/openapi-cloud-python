...
class CloudServiceConfiguration(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "price_day", "price_month", "mysql5", "mysql8", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "price_day", "price_month", "mysql5", "mysql8", ], str]):
