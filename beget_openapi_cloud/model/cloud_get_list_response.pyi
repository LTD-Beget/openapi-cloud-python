...
class CloudGetListResponse(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class service(
                ...
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['CloudService'], typing.List['CloudService']],
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["service", "total_count", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["service", "total_count", ], str]):
