...
class CloudService(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "configuration_id", "display_name", "description", "status", "created_at", "price_day", "price_month", "mysql5", "mysql8", "mysql84", "postgresql15", "postgresql14", "postgresql164", "s3", "manage_enabled", "slug", "monitorable_resources", "unblocking", "migrating", "region", "type", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "configuration_id", "display_name", "description", "status", "created_at", "price_day", "price_month", "mysql5", "mysql8", "mysql84", "postgresql15", "postgresql14", "postgresql164", "s3", "manage_enabled", "slug", "monitorable_resources", "unblocking", "migrating", "region", "type", ], str]):
